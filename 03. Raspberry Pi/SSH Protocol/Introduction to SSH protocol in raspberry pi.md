...
Download VNC Viewer from https://www.realvnc.com/ and install it on your computer or smartphone.

Open VNC Viewer and enter your Raspberry Pi’s IP address (e.g., 192.168.1.100) in the Address bar.
...
Interact with the Raspberry Pi’s desktop as if you were directly using it.

Transfer Files:
Use the VNC Viewer file transfer option to send or receive files between your computer and Raspberry Pi.

Further Exploration
Secure VNC Connection: Use a strong password by changing the Raspberry Pi password.

Access VNC Over the Internet: Set up port forwarding on your router for remote access outside your local network.
